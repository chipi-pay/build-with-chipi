...
export function SendUsdcPasskeyParamsSection() {
  ...
  return (
    <View style={styles.section}>
      <Text style={styles.kicker}>Feature: Send USDC (passkey path)</Text>
      <Text style={styles.hook}>Hook: useTransfer · usePasskey: true · externalUserId</Text>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>{isLoading ? 'Sending...' : 'Send with passkey'}</Text>
      </TouchableOpacity>
